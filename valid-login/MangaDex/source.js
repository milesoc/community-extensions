...
},{"./MangaDexHelper":74,"./MangaDexParser":75,"./MangaDexSettings":76,"./external/tag.json":77,"@paperback/types":61,"entities":71}],74:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.resetSettings = exports.thumbnailSettings = exports.accountSettings = exports.clientSecretSettings = exports.clientTokenSettings = exports.authEndpointRequest = exports.parseAccessToken = exports.contentSettings = exports.saveAccessToken = exports.getAccessToken = exports.getClientSecret = exports.getClientToken = exports.getMangaThumbnail = exports.getSearchThumbnail = exports.getHomepageThumbnail = exports.forcePort443 = exports.getSkipSameChapter = exports.getDataSaver = exports.getRatings = exports.getLanguages = void 0;
const MangaDexHelper_1 = require("./MangaDexHelper");
...
const getClientToken = async (stateManager) => {
    return await stateManager.retrieve('mdex_ctoken') ?? '';
};
exports.getClientToken = getClientToken;
const getClientSecret = async (stateManager) => {
    return await stateManager.retrieve('mdex_csecret') ?? '';
};
...
async function clientTokenSettings(stateManager) {
    return App.createDUIInputField({
        id: 'mdex_ctoken',
        label: 'MangaDex Personal Client Token',
        value: App.createDUIBinding({
            get: () => (0, exports.getClientToken)(stateManager),
            set: async (newValue) => {
                await stateManager.store('mdex_ctoken', newValue);
            }
        })
    });
}
exports.clientTokenSettings = clientTokenSettings;
async function clientSecretSettings(stateManager) {
    return App.createDUIInputField({
        id: 'mdex_csecret',
        label: 'MangaDex Personal Client Secret',
        value: App.createDUIBinding({
            get: () => (0, exports.getClientSecret)(stateManager),
            set: async (newValue) => {
                await stateManager.store('mdex_csecret', newValue);
            }
        })
    });
}
exports.clientSecretSettings = clientSecretSettings;
async function accountSettings(stateManager, requestManager) {
    ...
    if (!accessToken) {
        return App.createDUIOAuthButton({
            ...
            clientId: 'milesoc-personal-paperback',
